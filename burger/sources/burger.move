module burger::burger {
    ...
    // Function that allows the owner of the burger shop to collect profits
    public entry fun collect_profits(_owner: &BurgerShopOwner, shop: &mut BurgerShop, ctx: &mut TxContext){
